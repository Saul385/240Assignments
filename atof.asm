...
;  Date program began: 2022 October 26th
;  Date of last update: 2022 October 30th
;  Date of reorganization of comments: 2022 October 30th
...
convert_int_end:
; start a divisor with 1 as the beginning value
xorpd xmm11, xmm11
mov rax, 1
cvtsi2sd xmm11, rax
...
;Restore original values to the registers 
popf
pop rbx
pop r15
pop r14
