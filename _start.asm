...
; //  Author email: Sau385@csu.fullerton.edu
...
newline db 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0   ;Declare an array of 8 bytes 
tab db 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0    ;Declare an array of 8 bytes  
;Declare message outputs
welcome db "Welcome to Accurate Cosines by Saul Ruiz.", 10, 0
